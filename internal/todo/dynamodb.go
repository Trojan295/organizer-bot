...
func (r *DynamoDBRepository) Get(id string) (*List, error) {
	...
	value := resp.Item[dynamoValueKey]
	if value == nil {
		return &List{}, nil
	}
...
func (r *DynamoDBRepository) Save(id string, l *List) error {
	buf := bytes.Buffer{}
